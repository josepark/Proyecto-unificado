...
urlpatterns = [
    ...
    path('roles/<int:rid>/activo', views_api.RolActivoView.as_view()),
    path('roles/<int:rid>/certificar', views_api.RolCertificarView.as_view()),
    path('sistemas', views_api.SistemasListView.as_view()),
    path('sistemas/<int:sid>', views_api.SistemaDetailView.as_view()),
    path('sistemas/<int:sid>/activo', views_api.SistemaActivoView.as_view()),
    path('usuarios', views_api.UsuariosListView.as_view()),
    path('usuarios/<int:uid>', views_api.UsuarioDetailView.as_view()),
    path('usuarios/<int:uid>/estado', views_api.UsuarioEstadoView.as_view()),
    path('usuarios/<int:uid>/excepciones', views_api.UsuarioExcepcionesView.as_view()),
    path(
        'usuarios/<int:uid>/excepciones/<int:sid>',
        views_api.UsuarioExcepcionDetailView.as_view(),
    ),
    ...
    path('matriz/importar/analizar', views_api.MatrizImportarAnalizarView.as_view()),
    path('matriz/importar/confirmar', views_api.MatrizImportarConfirmarView.as_view()),
    path('excepciones', views_api.ExcepcionesListView.as_view()),
    path('excepciones/masiva', views_api.ExcepcionesMasivaView.as_view()),

...
urlpatterns = [
    ...
    path("api/token-jwt/refresh/", views.token_jwt_refresh, name="token_jwt_refresh"),
    path("api/mfa/estado/", views.mfa_estado, name="mfa_estado"),
    path("api/mfa/configurar/", views.mfa_configurar, name="mfa_configurar"),
    path("api/mfa/activar/", views.mfa_activar, name="mfa_activar"),
    path("api/mfa/desactivar/", views.mfa_desactivar, name="mfa_desactivar"),
    path("api/alertas/", views.alertas, name="alertas"),
    path("api/alertas/unificadas/", views.alertas_unificadas, name="alertas_unificadas"),
    path("api/integracion/vinculacion/", views.integracion_vinculacion, name="integracion_vinculacion"),
    path("api/integracion/vinculacion.csv", views.exportar_vinculacion_csv, name="exportar_vinculacion_csv"),
    ...
    path("api/interno/espacios/", views.espacios_interno, name="espacios_interno"),

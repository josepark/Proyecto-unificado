...
export const inventarioApi = {
  ...
  racksDatacenter: (id) => api.get(`/datacenters/${id}/racks/`),
  listarRacks: (params) => api.get('/racks/', { page_size: 200, ...params }),
  crearRack: (datos) => api.post('/racks/', datos),
  editarRack: (id, datos) => api.patch(`/racks/${id}/`, datos),
  eliminarRack: (id) => api.delete(`/racks/${id}/`),
  catalogoSistemasRbac: () => api.get('/catalogo/sistemas-rbac/'),
